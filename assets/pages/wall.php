...
<div class="container col-9 rounded-0 d-flex justify-content-between">
    <div class="col-8">
        <div class="card mt-4">
            <div class="card-title d-flex justify-content-between  align-items-center">
                ...
                <div class="d-flex align-items-center p-2">
                    <img src="assets/images/profile/mypro.jpg" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;Nur Ahad Sarker
                </div>
                <div class="p-2">
                    <i class="bi bi-three-dots-vertical"></i>
                </div>
            </div>
            <img src="assets/images/posts/268056044_2159569510858752_2276009856838956067_n.jpg" class="" alt="...">
        ...
        <div class="card mt-4">
            ...
            <img src="assets/images/posts/post-2.jpg" class="" alt="...">
            <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i class="bi bi-chat-left"></i>
            </h4>
            <div class="card-body">
                This is a wider card with supporting text below as a
        ...
        <div class="card mt-4">
            ...
            <img src="assets/images/posts/162680270_1923129554502750_5399589528207291269_n.jpg" class="" alt="...">
            <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i class="bi bi-chat-left"></i>
            </h4>
            <div class="card-body">
                This is a wider card with supporting text below as a
        ...
        <div class="card mt-4">
            ...
            <img src="assets/images/posts/65232273_1351516394997405_8834603374021181440_n.jpg" class="" alt="...">
            <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i class="bi bi-chat-left"></i>
            </h4>
            <div class="card-body">
                This is a wider card with supporting text below as a
        ...
        <div class="card mt-4">
            ...
            <img src="assets/images/posts/298935581_2376265035855864_890909719571052346_n.jpg" class="" alt="...">
            <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i class="bi bi-chat-left"></i>
            </h4>
            <div class="card-body">
                This is a wider card with supporting text below as a
